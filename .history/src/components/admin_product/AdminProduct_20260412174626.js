            ...
            {data &&
              ...
              data.map((item) => (
                <tr key={item._id}>
                  ...
                  <td>{item.brand}</td>
                  <td>
                    <img src={`/shoes_image/${item.type}/${item.category}/${item.image}`} alt="#" />
                  </td>
                  <td>{item.type} Shoes</td>
                  <td>{item.category && item.category !== "Boots" && item.category !== "Sandal" ? `${item.category} } </td>
