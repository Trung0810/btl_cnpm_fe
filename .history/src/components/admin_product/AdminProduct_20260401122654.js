      ...
      <div className="admin-product-wrapper">
        ...
        <table className="admin-product-table">
          <thead>
            ...
            <td className="admin-product-brand">Product Brand</td>
            <td className="admin-product-image">Product Image</td>
            <td className="admin-product-desc">Product Description</td>
            <td className="admin-product-cost">Product Cost</td>
            <td className="admin-product-action">Action</td>
          </thead>
          <tr>
