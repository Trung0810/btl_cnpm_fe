    ...
    <div className="cart-item">
      ...
      <div className="cart-item-quantity">
        <i
          ...
          onClick={() => handleSetQuantity(shoesId, color, size, "increment")}
        ></i>
        <span>{quantity}</span>
        <i
          className="fa fa-minus"
          onClick={() => handleSetQuantity(shoesId, color, size, "decrement")}
        ></i>
      </div>
      <p className="cart-item-cost">{price}</p>
      <div
        className="cart-item-delete"
        onClick={() => handleRemove(shoesId, color, size)}
      >
        <i className="fa fa-times" style={{ pointerEvents: "none" }}></i>
      </div>
    </div>
  );
};
