...
const LoginForm = () => {
  ...
  useEffect(() => {
    try {
      ...
      const eyeSlashIcon = document.querySelector(".fa fa-eye-slash");
      ...
      eyeIcon.addEventListener("click", handleShow);
      eyeSlashIcon.addEventListener("click", handleHide);

      return () => {
        eyeIcon.removeEventListener("click", handleShow);
        eyeSlashIcon.removeEventListener("click", handleHide);
      };
    } catch (e) {
      console.log(e);
    }
