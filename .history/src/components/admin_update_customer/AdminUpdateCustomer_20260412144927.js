...
const AdminUpdateCustomer = () => {
  ...
  const schema = yup.object({
    fullname: yup.string().required("Please enter product name!"),
    address: yup.string().required("Please select product brand!"),
    phone: yup.string().required("Please enter product image url!"),
    email: yup.string().required("Please enter product description!"),
  });
