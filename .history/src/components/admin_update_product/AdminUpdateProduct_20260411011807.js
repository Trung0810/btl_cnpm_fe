      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="admin-update-wrapper">
          ...
          <select name="brand" id="brand" {...register("brand")}>
            <option value=""></option>
            <option value="Nike" selected={data && data.brand === "Nike"}>
              Nike
            </option>
            <option value="Adidas" selected={data && data.brand === "Adidas"}>
              Adidas
            </option>
            <option value="Bitis" selected={data && data.brand === "Bitis"}>
              Bitis
            </option>
          </select>
        ...
        <div className="admin-update-wrapper">
          <button style={{ pointerEvents: isValidating ? "" : "none" }}>
            Update
          </button>
          <button
            onClick={(e) => {
