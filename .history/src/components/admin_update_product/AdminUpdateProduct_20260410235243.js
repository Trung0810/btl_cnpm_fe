...
const AdminUpdateProduct = () => {
  ...
  const schema = yup.object({
    ...
    image: yup.string().required("Please enter your fullname!"),

    description: yup.string().required("Please select your gender!"),
    price: yup.number().required("Please enter your email!"),
  });
