...
import NoficationPopup from "./NoficationPopup";
import "./AddToCartFormPopup.css";

const AddToCartFormPopup = ({ id, handleCancel, handleClose }) => {
  ...
  const onSubmit = (formData) => {
    ...
    console.log("🚀 ~ onSubmit ~ shoesValue:", shoesValue);

    (async () => await handleAddToCart(shoesValue))();
    handleClose();
  };
