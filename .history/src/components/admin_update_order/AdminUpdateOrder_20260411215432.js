...
const AdminUpdateOrder = () => {
  ...
  const schema = yupResolver.object({
    customerName: yup.string().required("Please enter product name!"),
    name: yup.string().required("Please select product brand!"),
    quantity: yup.string().required("Please enter product image url!"),
  });
